# EduFlowEduFlow | Your Unified Learning Hub
...
Since the platform is built using a single-file architecture, setup is instantaneous:

Save the code from index.html to your local machine.

Open index.html in any modern web browser (Chrome, Firefox, Safari, or Edge).

Ensure you have an active internet connection to load the Tailwind and Lucide CDNs.
